{* Here is a sample document Table of contents just
   Generate your own it using ezpublish template programing
 *}
...
<h2><a name="link_1">Chapter Title 1</a></h2>
    <h3><a name="link_1_1">Chapter Title 1.1</a></h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
         ...
         Cras ipsum dui, placerat lobortis, hendrerit sit amet, porta posuere, diam.
         Nulla rhoncus, velit ut pharetra hendrerit, neque lorem rutrum augue, at mattis
         lorem nisi a nulla. Suspendisse adipiscing tortor eget leo. Sed sagittis rhoncus odio.
         Suspendisse in arcu. Suspendisse ac neque. Etiam vitae dui. In ac elit. Mauris imperdiet
         urna in mi. Suspendisse potenti. Vivamus id risus sed elit mattis eleifend. Donec diam quam,
    ...
    <h3><a name="link_1_2">Chapter Title 1.2</a></h3>
         <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
         Nullam dapibus. Donec est quam, posuere eget, mollis nec, tristique eu, nisl.
         Pellentesque sem diam, viverra ac, vehicula in, pulvinar vel, metus.
         Cras ipsum dui, placerat lobortis, hendrerit sit amet, porta posuere, diam.
    ...
    <h3><a name="link_1_3">Chapter title 1.3</a></h3>
         <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
         Nullam dapibus. Donec est quam, posuere eget, mollis nec, tristique eu, nisl.
         Pellentesque sem diam, viverra ac, vehicula in, pulvinar vel, metus.
         Cras ipsum dui, placerat lobortis, hendrerit sit amet, porta posuere, diam.
        ...
        <h4><a name="link_1_3_1">Chapter Title 1.3.1</a></h4>
         <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
         Nullam dapibus. Donec est quam, posuere eget, mollis nec, tristique eu, nisl.
         Pellentesque sem diam, viverra ac, vehicula in, pulvinar vel, metus.
         Cras ipsum dui, placerat lobortis, hendrerit sit amet, porta posuere, diam.
        ...
        <h4><a name="link_1_3_2">Chapter Title 1.3.2</a></h4>
         <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
         Nullam dapibus. Donec est quam, posuere eget, mollis nec, tristique eu, nisl.
         Pellentesque sem diam, viverra ac, vehicula in, pulvinar vel, metus.
         Cras ipsum dui, placerat lobortis, hendrerit sit amet, porta posuere, diam.
